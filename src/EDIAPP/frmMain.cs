...
namespace EDIAPP
{
    ...
    public partial class frmMain : Form
    {
        ...
        private void frmMain_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                pr�f�rencesToolStripMenuItem_Click(pr�f�rencesToolStripMenuItem, new EventArgs());
        ...
        private void Init()
        {
            ...
            try
            {
                ...
                object[] arrDateFormats = { "Jour/Mois/Ann�e", "Mois/Jour/Ann�e", "Ann�e/Mois/Jour" };
        ...
        private void toolStripButton_Read_Click(object sender, EventArgs e)
        {
            ...
            else if (M_ENGINE == "BOMBARDIER")
            {
                ...
                {
                    MessageBox.Show("Edi_Engine_Bombardier n'a plus d'utilisation � un seul fichier.");
                    return;
                }
            }
            else if (M_ENGINE == "GENERIC" || M_ENGINE == "G�N�RIQUE")
            ...
            {
                //Messagebox.Show("V�rifiez le fichier de configuration. L'engin s�lectionner n'est pas valide.");
            }
        ...
        private void pr�f�rencesToolStripMenuItem_Click(object sender, EventArgs e)
        {
            EdiDbInterface dbSettingsInterface = null;
            object[] settings = null;
